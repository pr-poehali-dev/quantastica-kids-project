  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: "var(--q-bg)", fontFamily: "'Russo One', sans-serif" }}>
      ...
      <section className="relative overflow-hidden" style={{ background: "var(--q-bg)", minHeight: "90vh" }}>
          ...
          <div className="flex flex-wrap gap-10 sm:gap-16">
            {[
              ...
              <div key={i} className="flex items-center gap-4">
                <div className="w-1.5 h-12 rounded-full" style={{ background: "var(--q-yellow)" }} />
                <div>
                  <div className="font-russo text-4xl leading-none" style={{ color: "#fff" }}>{s.value}</div>
                  <div className="font-nunito text-sm mt-1" style={{ color: "rgba(255,255,255,0.5)" }}>{s.label}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* License + QR — bottom right corner */}
        <div className="absolute bottom-6 right-6 hidden lg:flex items-end gap-4">
          <div style={{ maxWidth: 240 }}>
            <p className="font-nunito text-xs leading-relaxed text-right" style={{ color: "rgba(255,255,255,0.45)" }}>
              Образовательная лицензия<br />
              № Л035-01298-77/02560522.<br />
              <span style={{ color: "rgba(255,255,255,0.3)" }}>
                Гарантия качества услуги по нормам и правилам,<br />установленным законодательством РФ
              </span>
            </p>
          </div>
          <div style={{ border: "1px solid rgba(255,255,255,0.2)", padding: 6, background: "#fff", borderRadius: 4 }}>
            <img
              src="https://cdn.poehali.dev/projects/447cdf21-ede9-440a-b225-e8c4bde91d6f/bucket/5dbf9b55-75a0-4d9e-b0a5-94973f5f378b.png"
              alt="QR лицензия"
                ...
                <div className="animate-bounce-in">
                  ...
                  <div className="mb-5 p-5 relative" style={{ background: "rgba(255,214,0,0.07)", border: "1px solid rgba(255,214,0,0.3)" }}>
                    ...
                    <div className="flex items-center gap-8">
                      <div>
                        ...
                        <div className="font-russo" style={{ fontSize: "4.5rem", lineHeight: 1, color: "rgba(255,255,255,0.3)", textDecoration: "line-through" }}>50</div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="font-russo" style={{ fontSize: "5.5rem", lineHeight: 1, color: "var(--q-yellow)" }}>3</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 mb-6 p-4" style={{ background: "rgba(255,107,157,0.08)", border: "1px solid rgba(255,107,157,0.25)" }}>
                    ...
                    <p className="font-nunito text-xs font-semibold leading-relaxed" style={{ color: "rgba(255,255,255,0.6)" }}>
                      Осталось всего <span style={{ color: "#FF6B9D", fontWeight: 700 }}>3 льготных места</span> из 50 выделенных вашей школе. Успейте записаться до окончания квоты.
                    </p>
                  </div>
